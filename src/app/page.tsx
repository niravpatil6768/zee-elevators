...
export default function Home() {
  ...
  const services = [
    {
      ...
      description:
        "Providing state-of-the-art, custom elevator installations for new buildings.",
    },
    {
      icon: <Wrench className="h-10 w-10 text-primary" />,
      title: "Maintenance",
      description:
        "Comprehensive maintenance plans to ensure safety and peak performance.",
    },
    {
      icon: <Zap className="h-10 w-10 text-primary" />,
      title: "Modernization",
      description:
        "Upgrading older elevators with the latest technology for better efficiency and safety.",
    },
  ];
  ...
  const testimonials = [
    {
      quote:
        "ZEE PLUS transformed our building's accessibility. Their installation was seamless, and the new elevators are a dream. Highly professional team from start to finish.",
      name: "Sarah Johnson",
      rating: 5,
    },
    {
      quote:
        "The modernization of our elevators was handled with utmost care and precision. The team was efficient, and the result is a significant improvement in performance and aesthetics.",
      name: "Michael Chen",
      rating: 5,
    },
    {
      quote:
        "Their 24/7 maintenance service is a lifesaver. Quick response times and knowledgeable technicians give us peace of mind. I can't recommend ZEE PLUS enough.",
  ...
  const faqs = [
    {
      ...
      answer:
        "We install a wide range of elevators, including passenger, freight, residential, and panoramic elevators. Our team works with you to determine the best solution for your building's specific needs and requirements.",
    },
    {
      question: "How often should an elevator be serviced?",
      answer:
        "Regular maintenance is crucial for safety and performance. We recommend a monthly service check for most commercial elevators, in line with industry best practices and local regulations. We offer flexible maintenance plans to suit your needs.",
    },
    {
      question: "Do you offer 24/7 emergency support?",
      answer:
        "Yes, we provide 24/7 emergency support to ensure your elevators are always running safely. Our dedicated team of technicians is on call to respond to any urgent issues promptly and efficiently.",
    },
    {
      question: "What is the process for modernizing an old elevator?",
      answer:
        "Our modernization process begins with a thorough assessment of your existing equipment. We then propose a tailored upgrade plan that can include new controllers, door operators, cabin interiors, and safety features to improve performance, reliability, and aesthetics.",
    },
  ];
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      >
        <div
          ref={animationRefs.services}
          className="container mx-auto text-center opacity-0"
        >
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8">
            {services.map((service) => (
              <Card
                key={service.title}
                className="text-center group hover:shadow-xl hover:-translate-y-2 transition-all duration-300"
              >
                <CardHeader>
      ...
      <section id="about" className="py-16 sm:py-20 md:py-24 bg-background">
        <div className="container mx-auto">
          <div
            ref={animationRefs.about}
            className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center opacity-0"
          >
            <div className="max-w-xl">
              <h2 className="font-headline text-3xl sm:text-4xl font-bold tracking-tight">
                About ZEE PLUS ELEVATORS
              </h2>
              <p className="mt-4 text-lg text-muted-foreground">
                At ZEE PLUS ELEVATORS, we are dedicated to providing the highest
                standards of reliability, safety, and customer satisfaction.
                Based in Jamnagar, we are your local experts for all vertical
                transportation needs, ensuring every project is completed with
                precision and care.
              </p>
            </div>
            <div>
          ...
          >
            <div className="text-center">
              ...
              <p className="mt-2 text-muted-foreground">
                The experienced team steering our mission.
              </p>
            </div>
      ...
      >
        <div
          ref={animationRefs.testimonials}
        ...
        >
          <div className="text-center">
            ...
            <p className="mt-4 max-w-2xl mx-auto text-lg text-primary-foreground/80">
              Our commitment to quality and service speaks for itself through
        ...
        >
          <div className="text-center">
            ...
            <p className="mt-4 max-w-2xl mx-auto text-lg text-muted-foreground">
              A showcase of our commitment to quality and excellence in elevator
              solutions.
            </p>
          </div>
      ...
      >
        <div ref={animationRefs.safety} className="container mx-auto opacity-0">
          <div className="text-center">
            ...
            <p className="mt-4 max-w-2xl mx-auto text-lg text-muted-foreground">
              We prioritize the safety of our clients and passengers above all
              else, reflected in our rigorous standards.
            </p>
          </div>
          <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="flex justify-center items-center">
              <ShieldCheck
                className="h-48 w-48 text-primary opacity-80"
                strokeWidth={1.5}
              />
            </div>
            <div>
              ...
              <ul className="mt-6 space-y-4">
                ...
                <li className="flex items-start gap-3">
                  <Check className="h-6 w-6 text-primary mt-1 shrink-0" />
                  <span className="text-muted-foreground">
                    Strict Adherence to National Safety Codes
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <Check className="h-6 w-6 text-primary mt-1 shrink-0" />
                  <span className="text-muted-foreground">
                    Regular and Thorough Maintenance Checks
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <Check className="h-6 w-6 text-primary mt-1 shrink-0" />
                  <span className="text-muted-foreground">
                    Use of High-Quality, Industry-Approved Parts
                  </span>
                </li>
              </ul>
            </div>
      ...
      <section id="contact" className="py-16 sm:py-20 md:py-24">
        ...
        >
          <div className="text-center">
            ...
            <p className="mt-4 max-w-2xl mx-auto text-lg text-muted-foreground">
              Have a question or need a quote? Reach out to us. Our team is
              ready to assist you.
            </p>
          </div>
            ...
            <div className="flex flex-col gap-8">
              <div>
                ...
                <p className="text-muted-foreground mt-2">
                  Fill out the form or use the information below to contact us.
                </p>
              </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Rydham Market, Plot No. 7, Shop No. 2, Kalyan Chowk,
                      Morkanda Road, Jamnagar - 361 001.
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
